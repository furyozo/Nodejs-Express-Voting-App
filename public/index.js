...
var PollForm = function (_React$Component) {
  ...
  function PollForm(props) {
    ...
    _this.state = { inputCount: 3 };
    _this.inputarr = [];
    for (var i = 0; i < _this.state.inputCount; i++) {
      _this.inputarr.push(1);
    }
    return _this;
  }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.inputarr.map(function (key, i) {
            ...
            return _react2.default.createElement(
              'div',
              { key: i, className: 'form-group' },
              _react2.default.createElement('input', { className: 'form-control poll-input', placeholder: 'Option ...', name: 'option[]', type: 'text', onChange: function onChange() {
                  _this2.inputChange();
                } })
            );
          }, this),
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: 'btn btn-lg btn-default', type: 'submit', name: 'button' },
              'Create a new Poll'
            )
          )
        )
